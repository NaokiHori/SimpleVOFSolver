 ...
 * @return                : error code
 */
int logging(const domain_t *domain, const int step, const double time, const double dt, const double wtime, const fluid_t *fluid, const temperature_t *temperature, const interface_t *interface){
  if(!is_scheduled){
    ...
    check_interface (DIRNAME_LOG "/interface.dat",  domain, time, interface);
