 ...
 * @return                   : error code
 */
int compute_rhs_ux(const domain_t * restrict domain, const int rkstep, fluid_t * restrict fluid, const temperature_t * restrict temperature, const interface_t *interface){
  ...
  const double * restrict voffrcx = interface->voffrcx;
 ...
 * @return                   : error code
 */
int compute_rhs_ux(const domain_t * restrict domain, const int rkstep, fluid_t * restrict fluid, const temperature_t * restrict temperature, const interface_t * restrict interface){
  const int implicitx = config.get_bool("implicitx");
  const int implicity = config.get_bool("implicity");
