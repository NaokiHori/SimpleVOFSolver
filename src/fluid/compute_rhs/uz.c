 ...
 * @return              : error code
 */
int compute_rhs_uz(const domain_t * restrict domain, const int rkstep, fluid_t * restrict fluid, const interface_t * restrict interface){
  ...
  const double * restrict voffrcz = interface->voffrcz;
