 ...
 * @return              : error code
 */
int compute_rhs_uy(const domain_t * restrict domain, const int rkstep, fluid_t * restrict fluid, const interface_t * restrict interface){
  ...
  const double * restrict voffrcy = interface->voffrcy;
